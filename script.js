...
// removed old readagain const (we'll use the correct id below)
...
/* ------------------------
   Read Again wiring (fixed to match HTML id)
   ------------------------ */
document.getElementById("readAgainBtn").addEventListener("click", function () {
    // simplest & reliable: reload page to fully reset everything
    location.reload();
});
